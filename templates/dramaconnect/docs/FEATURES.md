# 📖 __DC_APP_NAME__ v14.1 — Detailed Feature Guide
...
- A branded __DC_ORG_NAME__ Drama **membership card** with the member's name, role,
...
truth. __DC_PROVINCE__'s own deployment uses lifetime ownership and therefore needs no registry.
