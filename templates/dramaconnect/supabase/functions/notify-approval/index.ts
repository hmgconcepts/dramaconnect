  ...
  try {
    ...
    const html = `
      <div style="font-family:Arial,sans-serif;max-width:560px;margin:auto">
        <div style="background:__DC_PRIMARY_COLOR__;color:#fff;padding:24px;text-align:center;border-radius:12px 12px 0 0">
          <h2 style="margin:0">DramaConnect</h2>
          <p style="margin:4px 0 0;opacity:.9">__DC_ORG_NAME__</p>
        </div>
        <div style="border:1px solid #e2e8f0;border-top:none;padding:24px;border-radius:0 0 12px 12px">
          ...
          <p style="text-align:center;margin:28px 0">
            <a href="${escapeHtml(appUrl)}" style="background:__DC_PRIMARY_COLOR__;color:#fff;text-decoration:none;padding:12px 24px;border-radius:8px;font-weight:bold">Open DramaConnect</a>
          </p>
