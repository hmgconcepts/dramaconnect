...
CREATE TABLE IF NOT EXISTS public.tenant_settings (
  ...
  app_name    TEXT DEFAULT '__DC_APP_NAME__',
  org_name    TEXT DEFAULT '__DC_ORG_NAME__',
...
VALUES (1, '__DC_APP_NAME__', '__DC_ORG_NAME__') 
ON CONFLICT (id) DO NOTHING;
...
BEGIN
  ...
  IF to_regclass('public.tenant_settings') IS NOT NULL THEN
    ALTER TABLE public.tenant_settings
      ADD COLUMN IF NOT EXISTS primary_color TEXT DEFAULT '__DC_PRIMARY_COLOR__';
  END IF;
END $dc_guard$;
...
CREATE TABLE IF NOT EXISTS public.dc_site_license (
  ...
  licensed_to TEXT NOT NULL DEFAULT '__DC_ORG_NAME__',
...
VALUES (
  ...
  '__DC_ORG_NAME__', CURRENT_DATE, NULL, 14,
